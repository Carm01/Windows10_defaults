...
:: Enable NumLOck
REG ADD "HKU\DefaultUser\Control Panel\Keyboard" /v "InitialKeyboardIndicators" /d 2 /t REG_SZ /f
...
REG ADD "HKU\DefaultUser\Software\Microsoft\input\Settings\" /v "InsightsEnabled" /d 0 /t REG_DWORD /f
